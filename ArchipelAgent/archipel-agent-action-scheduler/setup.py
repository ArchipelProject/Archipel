...
SHORTDESCRIPTION    = "Creation and management of planified tasks for hypervisors and virtual machines"
LONGDESCRIPTION     = ""
ENTRY_POINTS        = { 'archipel.plugin.virtualmachine' : [
                            'factory=archipelagentactionscheduler:make_archipel_plugin'],
                        'archipel.plugin.hypervisor' : [
                            'factory=archipelagentactionscheduler:make_archipel_plugin'],
                        'archipel.plugin' : [
...
setup(name=NAME,
      ...
      data_files=[
        ('/etc/archipel/modules.d/' , ["install/etc/archipel/modules.d/actionscheduler.conf"])
        ]
      )
