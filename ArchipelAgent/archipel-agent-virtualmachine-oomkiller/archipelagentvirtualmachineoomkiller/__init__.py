...
def make_archipel_plugin(configuration, entity, group):
    ...
    """
    return [{"info": oomkiller.TNOOMKiller.plugin_info(),
             "plugin": oomkiller.TNOOMKiller(configuration, entity, group)}]
...
def version():
    ...
    return (__name__, pkg_resources.get_distribution("archipel-agent-virtualmachine-oomkiller").version, [oomkiller.TNOOMKiller.plugin_info()])