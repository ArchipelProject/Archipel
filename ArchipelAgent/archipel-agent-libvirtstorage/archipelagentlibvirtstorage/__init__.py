...
def make_archipel_plugin(configuration, entity, group):
    ...
    """
    return [{"info": libvirtStorage.TNLibvirtStorageManagement.plugin_info(),
             "plugin": libvirtStorage.TNLibvirtStorageManagement(configuration, entity, group)}]
...
def version():
    ...
    return (__name__, pkg_resources.get_distribution("archipel-agent-libvirtstorage").version, [libvirtStorage.TNLibvirtStorageManagement.plugin_info()])