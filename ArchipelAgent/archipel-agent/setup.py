...
setup(name='archipel-agent',
      ...
      install_requires=[
        "sqlobject>=0.14.1",
        "archipel-core>=1.0.2beta",
        "archipel-agent-action-scheduler>=1.0.15beta",
        "archipel-agent-hypervisor-geolocalization>=1.0.16beta",
        "archipel-agent-hypervisor-health>=1.0.18beta",
        "archipel-agent-hypervisor-network>=1.0.16beta",
        "archipel-agent-iphone-notification>=1.0.15beta",
        "archipel-agent-virtualmachine-oomkiller>=1.0.16beta",
        "archipel-agent-virtualmachine-snapshoting>=1.0.16beta",
