...
setup(name='archipel-agent',
      ...
      install_requires=[
        ...
        "archipel-agent-action-scheduler>=1.0.16beta",
        "archipel-agent-hypervisor-geolocalization>=1.0.17beta",
        "archipel-agent-hypervisor-health>=1.0.19beta",
        "archipel-agent-hypervisor-network>=1.0.17beta",
        "archipel-agent-iphone-notification>=1.0.16beta",
        "archipel-agent-virtualmachine-oomkiller>=1.0.17beta",
        "archipel-agent-virtualmachine-snapshoting>=1.0.17beta",
        "archipel-agent-virtualmachine-storage>=1.0.21beta",
        "archipel-agent-vmcasting>=1.0.18beta",
        "archipel-agent-xmppserver>=1.0.18beta",
        "archipel-agent-virtualmachine-vnc>=1.0.4beta"
      ],
      entry_points="""
        # -*- Entry points: -*-
        """,
