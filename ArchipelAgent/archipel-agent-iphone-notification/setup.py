...
SHORTDESCRIPTION    = "Can send notification to iPhone using PushApp 3.0"
LONGDESCRIPTION     = ""
ENTRY_POINTS        = { 'archipel.plugin.hypervisor' : [
                            'factory=archipelagentiphonenotification:make_archipel_plugin'],
                        'archipel.plugin.virtualmachine' : [
                            'factory=archipelagentiphonenotification:make_archipel_plugin'],
                        'archipel.plugin' : [
                            'version=archipelagentiphonenotification:version']}
...
setup(name=NAME,
      ...
      data_files=[
        ('install/etc/archipel/modules.d/' , ["install/etc/archipel/modules.d/iphone_notification.conf"])
        ]
      )
