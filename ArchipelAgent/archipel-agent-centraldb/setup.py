...
MAIL                = 'nicolas.ochem@free.fr'
URL                 = 'http://archipelproject.org'
LICENSE             = 'AGPL'
NAME                = 'archipel-agent-centraldb'
SHORTDESCRIPTION    = "Handle connection with the central agent"
LONGDESCRIPTION     = ""
ENTRY_POINTS        = { 'archipel.plugin.hypervisor' : [
                            'factory=archipelagentcentraldb:make_archipel_plugin'],
                        'archipel.plugin.virtualmachine' : [
                            'factory=archipelagentcentraldb:make_archipel_plugin'],
                        'archipel.plugin.centralagent' : [
                            'factory=archipelagentcentraldb:make_archipel_plugin'],
                        'archipel.plugin' : [
                            'version=archipelagentcentraldb:version']}
...
setup(name=NAME,
      ...
      data_files=[
        ('install/etc/archipel/modules.d/' , ["install/etc/archipel/modules.d/centraldb.conf"])
        ]
      )
