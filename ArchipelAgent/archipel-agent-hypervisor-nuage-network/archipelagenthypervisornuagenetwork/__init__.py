...
def make_archipel_plugin(configuration, entity, group):
    ...
    """
    return [{"info": nuageNetwork.TNHypervisorNuageNetworks.plugin_info(),
             "plugin": nuageNetwork.TNHypervisorNuageNetworks(configuration, entity, group)}]
...
def version():
    ...
    return (__name__, pkg_resources.get_distribution("archipel-agent-hypervisor-nuage-network").version, [nuageNetwork.TNHypervisorNuageNetworks.plugin_info()])