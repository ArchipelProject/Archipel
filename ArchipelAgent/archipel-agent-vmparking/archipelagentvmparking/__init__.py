...
def make_archipel_plugin(configuration, entity, group):
    ...
    """
    return [{"info": vmparking.TNVMParking.plugin_info(),
             "plugin": vmparking.TNVMParking(configuration, entity, group)}]
...
def version():
    ...
    return (__name__, pkg_resources.get_distribution("archipel-agent-vmparking").version, [vmparking.TNVMParking.plugin_info()])