...
SHORTDESCRIPTION    = "manage VNC screen connection"
LONGDESCRIPTION     = ""
ENTRY_POINTS        = { 'archipel.plugin.virtualmachine' : [
                            'factory=archipelagentvirtualmachinevnc:make_archipel_plugin'],
                        'archipel.plugin' : [
                            'version=archipelagentvirtualmachinevnc:version']}
RPM_REQUIRED_DEPS   = "archipel-core, numpy"
