...
# 
# 
# class TNArchipelWebSocketProxy(Thread):
#     
...
#         try:
#             self.do_proxy(self.client, tsock)
#         except:
...
# 
# 
# class TNArchipelWebSocket(Thread):
#     
...
#                 
#                 p = TNArchipelWebSocketProxy(csock, self.target_host, self.target_port)
#                 p.start()
#             except Exception:
