...
def __module_init__health_module(self):
    ...
    min_row_before_storing  = self.configuration.getint("HEALTH", "min_row_before_storing")
    ...
    self.module_health = health.TNHypervisorHealth(db_file, collection_interval, max_rows_before_purge, min_row_before_storing) #, snmp_infos)
