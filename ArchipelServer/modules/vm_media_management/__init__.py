...
def __module_init__disk_management(self):
    shared_isos_folder = self.configuration.get("Module Medias", "iso_base_path") + "/"
...
def __module_register_stanza__disk_management(self):
    self.xmppclient.RegisterHandler('iq', self.module_media.process_iq, typ=NS_ARCHIPEL_VM_DISK)
