...
- (id)initWithFrame:(CPRect)aFrame
{
    if (self = [super initWithFrame:aFrame])
    {
        ...
        var bUpBezelColor = [CPColor colorWithPatternImage:[[CPThreePartImage alloc] initWithImageSlices:
            ...
            bUpBezelColorHighlighted = [CPColor colorWithPatternImage:[[CPThreePartImage alloc] initWithImageSlices:
            [
            ...
            bUpBezelColorDisabled = [CPColor colorWithPatternImage:[[CPThreePartImage alloc] initWithImageSlices:
            [
        ...
        var bDownBezelColor = [CPColor colorWithPatternImage:[[CPThreePartImage alloc] initWithImageSlices:
            ...
            bDownBezelColorHighlighted = [CPColor colorWithPatternImage:[[CPThreePartImage alloc] initWithImageSlices:
            [
            ...
            bDownBezelColorDisabled = [CPColor colorWithPatternImage:[[CPThreePartImage alloc] initWithImageSlices:
            [
