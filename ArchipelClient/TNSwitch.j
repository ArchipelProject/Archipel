...
+ (id)themeAttributes
{
    ...
    var switchSize = CGSizeMake(77, 24);
    
    var offBackgroundImage = [CPColor colorWithPatternImage:[[CPImage alloc] initWithContentsOfFile:[mainBundle pathForResource:@"LPSwitch/switch-off-background.png"] size:switchSize]];
    var onBackgroundImage = [CPColor colorWithPatternImage:[[CPImage alloc] initWithContentsOfFile:[mainBundle pathForResource:@"LPSwitch/switch-on-background.png"] size:switchSize]];
    var knobBackgroundImage = [CPColor colorWithPatternImage:[[CPImage alloc] initWithContentsOfFile:[mainBundle pathForResource:@"LPSwitch/switch-knob.png"] size:switchSize]];
    var highlightedKnobBackgroundImage = [CPColor colorWithPatternImage:[[CPImage alloc] initWithContentsOfFile:[mainBundle pathForResource:@"LPSwitch/switch-knob-highlighted.png"] size:switchSize]];
...
{
    var mainBundle  = [CPBundle mainBundle];
    var aSwitch     = [[TNSwitch alloc] initWithFrame:aFrame];
    var switchSize  = CGSizeMake(77, 24);
...
- (id)initWithFrame:(CGRect)aFrame
{
    ...
    aFrame.size.height = 24;
    
    if (self = [super initWithFrame:aFrame])
    {
        var mainBundle  = [CPBundle mainBundle];
        var switchSize  = CGSizeMake(aFrame.size.width, aFrame.size.height);
