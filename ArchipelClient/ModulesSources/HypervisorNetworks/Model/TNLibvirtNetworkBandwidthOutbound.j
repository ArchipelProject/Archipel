/*
 * TNLibvirtNetworkBandwidthOutbound.j
 *
...
/*! Create a new TNLibvirtNetworkBandwidthOutbound object
    @param anAverage the value of average
    @param aPeak the value of peak
    @param aBurst the value of burst
*/
+ (TNLibvirtNetworkBandwidthOutbound)defaultNetworkBandwidthOutboundWithAverage:(CPString)anAverage peak:(CPString)aPeak burst:(CPString)aBurst
{
    var outbound = [[TNLibvirtNetworkBandwidthOutbound alloc] init];
